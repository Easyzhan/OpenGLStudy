...
- (void)viewDidLoad {
    ...
    UIImage *image = [UIImage imageNamed:@"window"];
    ...
    //纹理贴图
    NSString* filePath = [[NSBundle mainBundle] pathForResource:@"ticketsLOGO" ofType:@"png"];
    NSDictionary* options = [NSDictionary dictionaryWithObjectsAndKeys:@(1), GLKTextureLoaderGrayscaleAsAlpha, nil];//GLKTextureLoaderOriginBottomLeft 纹理坐标系是相反的
